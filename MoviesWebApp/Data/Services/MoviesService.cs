...
namespace MoviesWebApp.Data.Services
{
    public class MoviesService : EntityBaseRepository<Movie>, IMoviesService
    {
        ...
        public MoviesService(MovieAppDbContext context) : base(context)
        {
            _context = context;
        }
        ...
        // Below is cleaner code than the commented out code below as it more clearly
        // shows method obtaining Actors, Cinemas, Producers from the database
        ...
        public async Task UpdateMovieAsync(NewMovieVM data)
        {
            ...
            //Remove existing actors for this movie
            var existingActorsDb = _context.Actors_Movies.Where(n => n.MovieId == data.Id).ToList();
            _context.Actors_Movies.RemoveRange(existingActorsDb);
            await _context.SaveChangesAsync();


            // Add updated list of actors to the Actor_Movie list
            foreach (var actorId in data.ActorIds)
            {
                var newActorMovie = new Actor_Movie()
                {
